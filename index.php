...
<body class="">
            ...
            <div class="card rounded-0 shadow">
                <div class="card-header rounded-0">
                    <div class="d-flex">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-sm btn-primary rounded-0" id="add_pass"><i class="fa fa-plus"></i> Add Password</button>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <?php while($row = $data->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="p-1"><a href="<?= $row['site']?>" target="_blank"><?= $row['site']?></a></td>
    ...
    <nav>
        <div class="text-center text-muted">Developed by <a class="text-decoration-none" href="mailto:chotelalbhagat@gmail.com" target="_blank">Chotelal Bhagat</a> and published</div>
    </nav>
</body>
