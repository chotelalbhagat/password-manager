...
<head>
    ...
    <title>Password Storage App</title>
...
<body class="">
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="./">Password Storage App</a>
            ...
            <div class="card rounded-0 shadow">
                <div class="card-header rounded-0">
                    <div class="d-flex">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-sm btn-primary rounded-0" id="add_pass"><i class="fa fa-plus"></i>
                                Add Password</button>
                        </div>
                    </div>
                </div>
                <div class="card-body rounded-0">
                    <fieldset>
                        ...
                        <p class="text-muted ps-4">Hover the Encrypted Password Table Cell to view the Decrypted
                            Password</p>
                    </fieldset>
                                ...
                                <?php if ($data->num_rows > 0): ?>
                                    <?php while ($row = $data->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="p-1"><a href="<?= $row['site'] ?>" target="_blank"><?= $row['site'] ?></a>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    <button
                                                        class="btn btn-sm btn-light border border-dark dropdown-toggle rounded-0"
                                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        Action
                                                    </button>
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item edit_record" href="javascript:void(0)"
                                                                data-id="<?= $row['id'] ?>">Edit</a></li>
                                                        <li><a class="dropdown-item"
                                                                href="api.php?action=delete_record&id=<?= $row['id'] ?>"
                                                                onclick="if(confirm('Are you sure to delete this record?') == false) event.preventDefault();">Delete</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
                    ...
                    <div class="container-fluid">
                        <form action="" id="password-form" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-0" id="username" name="username" value=""
                                    required="required">
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group rounded-0">
                                    ...
                                    <button class="input-group-button btn btn-light border password_show" tabindex="-1"
                                        type="button"><i class="fa fa-eye-slash"></i></button>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-0" id="site" name="site" value="">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <nav>
        <div class="text-center text-muted">Developed by <a class="text-decoration-none"
                href="mailto:chotelalbhagat@gmail.com" target="_blank">Chotelal Bhagat</a> and published</div>
    </nav>
</body>
